...
\title{CompReducer : tools for quickly and automatically create components to aid building resource adaptive software systems}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Arpit Christi}
\IEEEauthorblockA{EECS\\
